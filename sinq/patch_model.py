...
from .cprlinear import CPRLinear
from .awq import *
...
_QUANT_LAYERS = [nn.Linear, SINQLinear, CPRLinear]
    ...
    def from_quantized_safetensors(
        ...
        **kwargs,
        ...
        def _load_module(module, params=None):
            ...
            # Quantized CPRLinear (mixed-precision column-reordering)
            if "W_high_packed" in state_dict:
                m = CPRLinear.from_state_dict(
                    state_dict,
                    device=device,
                    compute_dtype=compute_dtype,
                )
